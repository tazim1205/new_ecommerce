...
<div class="page-heading">
    <h1 class="page-title">@lang('trend.create_title')</h1>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <form method="post" action="{{route('trend.update',$data->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12" id="inputSingleBox">
                                <div>
                                <label for="defaultFormControlInput" class="form-label">@lang('trend.trend_name_en') <span class="text-danger">*</span></label>
                                <input
                                    type="text"
                                    class="form-control"
                                    id="defaultFormControlInput"
                                    placeholder="@lang('trend.trend_name_en')"
                                    aria-describedby="defaultFormControlHelp"
                                    name="trend_name_en"
                                    required
                                    value="{{$data->trend_name_en}}"
                                />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12" id="inputSingleBox">
                                <div>
                                <label for="defaultFormControlInput" class="form-label">@lang('trend.trend_name_bn') <span class="text-danger">*</span></label>
                                <input
                                    type="text"
                                    class="form-control"
                                    id="defaultFormControlInput"
                                    placeholder="@lang('trend.trend_name_bn')"
                                    aria-describedby="defaultFormControlHelp"
                                    name="trend_name_bn"
                                    required
                                    value="{{$data->trend_name_bn}}"
                                />
                                </div>
                            </div>
