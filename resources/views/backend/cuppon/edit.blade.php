    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <form method="post" action="{{route('cuppon.update',$data->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12" id="inputSingleBox">
                                <div>
                                <label for="defaultFormControlInput" class="form-label">@lang('cuppon.cuppon_code') <span class="text-danger">*</span></label>
                                <input
                                    type="text"
                                    class="form-control"
