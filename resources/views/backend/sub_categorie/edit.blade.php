...
<div class="page-heading">
    <h1 class="page-title">@lang('sub_categorie.create_title')</h1>
...
<div class="page-content fade-in-up">
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">@lang('sub_categorie.create_title')</div>

                </div>
                <div class="ibox-body">
                    <form method="post" action="{{route('sub_categorie.update',$data->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12" id="inputSingleBox">
                                <div>
                                <label for="defaultFormControlInput" class="form-label">@lang('sub_categorie.sub_cat_name_en') <span class="text-danger">*</span></label>
                                <input
                                    type="text"
                                    class="form-control"
                                    id="defaultFormControlInput"
                                    placeholder="@lang('sub_categorie.sub_cat_name_en')"
                                    aria-describedby="defaultFormControlHelp"
                                    name="sub_cat_name_en"
                                    required
                                    value="{{$data->sub_cat_name_en}}"
                                />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12" id="inputSingleBox">
                                <div>
                                <label for="defaultFormControlInput" class="form-label">@lang('sub_categorie.sub_cat_name_bn') <span class="text-danger">*</span></label>
                                <input
                                    type="text"
                                    class="form-control"
                                    id="defaultFormControlInput"
                                    placeholder="@lang('sub_categorie.sub_cat_name_bn')"
                                    aria-describedby="defaultFormControlHelp"
                                    name="sub_cat_name_bn"
                                    required
                                    value="{{$data->sub_cat_name_bn}}"
                                />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12" id="inputSingleBox">
                                <div>
                                <label for="defaultFormControlInput" class="form-label">@lang('sub_categorie.order_by') <span class="text-danger">*</span></label>
                                <input
                                    type="text"
                                    class="form-control"
                                    id="defaultFormControlInput"
