    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <form method="post" action="{{route('add_product_to_trend.update',$data->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12" id="inputSingleBox">
                            <div>
                                ...
                                <select class="form-control" id="cat_id" name="cat_id" onchange="return GetSelectProduct()" required>
                                    ...
                                    <option value="{{$v->id}}" @if($v->id == $data->cat_id) selected @endif>@if($lang == 'en'){{$v->cat_name_en}}
                            ...
                            <div>
                                ...
                                <select class="form-control" id="trend_id" name="trend_id" required>
                                    ...
                                    <option value="{{$v->id}}" @if($v->id == $data->trend_id) selected @endif>@if($lang == 'en'){{$v->trend_name_en}}
